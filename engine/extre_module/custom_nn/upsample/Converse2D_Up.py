...
class Converse2D_Up(nn.Module):     
    def __init__(self, in_channels, out_channels, kernel_size=3, scale=2, padding_mode='circular', eps=1e-5):     
...
if __name__ == '__main__':  
    ...
    # 此模块仅支持输入和输出通道数一致的情况
    module = Converse2D_Up(in_channel, out_channel, kernel_size=3).to(device) 
